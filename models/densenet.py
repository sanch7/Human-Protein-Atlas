...
def Atlas_DenseNet(model = "densenet121", bn_size=4, drop_rate=0.):
    """
    Params:
    ...
    model = model(bn_size=bn_size, drop_rate=drop_rate)
    return model
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
                 num_init_features=64, bn_size=4, drop_rate=0.2, num_classes=28):
