#https://github.com/soeaver/AirNet-PyTorch
...
def Atlas_AirX(model_name = "airx50_32x4d", pretrained=False, drop_rate=0., 
                        num_channels=4):
    if model_name == "airx50_32x4d":
        print("Using airx50_32x4d")
        model = airx50_32x4d()
        if pretrained:
            print('Loading weights...')
            state_dict = torch.load('/home/litemax/.torch/models/airx50_32x4d.pth')
